...
namespace TodoApi.ImageProcessorLambda;
    ...
    public async Task FunctionHandler(S3Event evnt, ILambdaContext context)
    {
        ...
        foreach (var record in eventRecords)
        {
            ...
            try
            {
                ...
                {
                    context.Logger.LogInformation($"Item with key {s3Event.Object.Key} has already been resized");
                    continue;
                }

                await using var itemStream = await this.S3Client.GetObjectStreamAsync(s3Event.Bucket.Name,
                ...
                context.Logger.LogInformation($"Image with id {s3Event.Object.Key} has been processed");
            }
            catch (Exception e)
            {
