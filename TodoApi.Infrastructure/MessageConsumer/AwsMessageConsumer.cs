...
{
    public class AwsMessageConsumer : IMessageConsumer
    {
        ...
        public AwsMessageConsumer(ILogger<MessageConsumerFactory> logger, IMediator mediator, IOptions<SqsOptions> options, IOptions<AwsCredentialsOptions> credentialsOptions)
        {
